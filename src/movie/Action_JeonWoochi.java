...
public class Action_JeonWoochi {

	public Action_JeonWoochi() {
		...
		Label q2 = new Label(i.getAction_JeonWoochi_Actor());
		...
		Label q3 = new Label(i.getAction_JeonWoochi_Name());
		...
		ta.append(i.getAction_JeonWoochi_Outline());
