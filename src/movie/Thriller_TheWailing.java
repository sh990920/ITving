...
public class Thriller_TheWailing {
	public Thriller_TheWailing() {
		...
		Label q2 = new Label(i.getThriller_TheWailing_Actor());
		...
		Label q3 = new Label(i.getThriller_TheWailing_Name());
		...
		ta.append(i.getThriller_TheWailing_Outline());
