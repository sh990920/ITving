...
public class Comedy {
	public Comedy() {
		...
		// 영화 포스터
		JButton a1 = new JButton(new ImageIcon("이미지/코미디_과속스캔들.png"));
		JButton a2 = new JButton(new ImageIcon("이미지/코미디_극한직업.png"));
		JButton a3 = new JButton(new ImageIcon("이미지/코미디_스물.png"));
		JButton a4 = new JButton(new ImageIcon("이미지/코미디_피끓는 청춘.png"));
