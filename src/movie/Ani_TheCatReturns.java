...
public class Ani_TheCatReturns {

	public Ani_TheCatReturns() {
		...
		Label q2 = new Label(i.getAni_TheCatReturns_Actor());
		...
		Label q3 = new Label(i.getAni_TheCatReturns_Name());
		...
		ta.append(i.getAni_TheCatReturns_Outline());
