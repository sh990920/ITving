...
public class Ani_Ponyo {
	...
	public Ani_Ponyo() {
		...
		Label q2 = new Label(i.getAni_Ponyo_Actor());
		...
		Label q3 = new Label(i.getAni_Ponyo_Name());
		...
		ta.append(i.getAni_Ponyo_Outline());
