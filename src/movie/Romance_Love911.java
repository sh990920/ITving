...
public class Romance_Love911 {

	public Romance_Love911() {
		...
		Label q2 = new Label(i.getRomance_Love911_Actor());
		...
		Label q3 = new Label(i.getRomance_Love911_Name());
		...
		ta.append(i.getRomance_Love911_Outline());
