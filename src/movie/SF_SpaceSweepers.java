...
public class SF_SpaceSweepers {

	public SF_SpaceSweepers() {
		...
		Label q2 = new Label(i.getSF_SpaceSWEEPERS_Actor());
		...
		Label q3 = new Label(i.getSF_SpaceSWEEPERS_Name());
		...
		ta.append(i.getSF_SpaceSWEEPERS_Outline());
