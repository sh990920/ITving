...
public class Ani_SenAndChihiro {

	public Ani_SenAndChihiro() {
		...
		Label q2 = new Label(i.getAni_SenAndChihiro_Actor());
		...
		Label q3 = new Label(i.getAni_SenAndChihiro_Name());
		...
		ta.append(i.getAni_SenAndChihiro_Outline());
