...
public class Romance_YourWedding {

	public Romance_YourWedding() {
		...
		Label q2 = new Label(i.getRomance_YourWedding_Actor());
		...
		Label q3 = new Label(i.getRomance_YourWedding_Name());
		...
		ta.append(i.getRomance_YourWedding_Outline());
