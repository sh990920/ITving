...
public class Romance_WolfBoy {

	public Romance_WolfBoy() {
		...
		Label q2 = new Label(i.getRomance_WolfBoy_Actor());
		...
		Label q3 = new Label(i.getRomance_WolfBoy_Name());
		...
		ta.append(i.getRomance_WolfBoy_Outline());
