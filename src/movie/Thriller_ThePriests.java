...
public class Thriller_ThePriests {
	public Thriller_ThePriests() {
		...
		Label q2 = new Label(i.getThriller_ThePriests_Actor());
		...
		Label q3 = new Label(i.getThriller_ThePriests_Name());
		...
		ta.append(i.getThriller_ThePriests_Outline());
