...
public class Thriller_HideAndSeek {
	public Thriller_HideAndSeek() {
		...
		Label q2 = new Label(i.getThriller_HideAndSeek_Actor());
		...
		Label q3 = new Label(i.getThriller_HideAndSeek_Name());
		...
		ta.append(i.getThriller_HideAndSeek_Outline());
