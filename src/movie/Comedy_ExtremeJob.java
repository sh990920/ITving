...
public class Comedy_ExtremeJob {

	public Comedy_ExtremeJob() {
		...
		Label q2 = new Label(i.getComedy_ExtremeJob_Actor());
		...
		Label q3 = new Label(i.getComedy_ExtremeJob_Name());
		...
		ta.append(i.getComedy_ExtremeJob_Outline());
