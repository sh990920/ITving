...
public class SF_SnowPiercer {

	public SF_SnowPiercer() {
		...
		Label q2 = new Label(i.getSF_SnowPiercer_Actor());
		...
		Label q3 = new Label(i.getSF_SnowPiercer_Name());
		...
		ta.append(i.getSF_SnowPiercer_Outline());
