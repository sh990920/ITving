...
public class Thriller_Gonjiam {
	public Thriller_Gonjiam() {
		...
		JButton btn_age = new JButton(new ImageIcon("이미지/19세.png"));
		...
		Label q2 = new Label(i.getThriller_Gonjiam_Actor());
		...
		Label q3 = new Label(i.getThriller_Gonjiam_Name());
		...
		ta.append(i.getThriller_Gonjiam_Outline());
