...
public class Comedy_HotYoungBloods {

	public Comedy_HotYoungBloods() {
		...
		Label q2 = new Label(i.getComedy_HotYoungBloods_Actor());
		...
		Label q3 = new Label(i.getComedy_HotYoungBloods_Name());
		...
		ta.append(i.getComedy_HotYoungBloods_Outline());
