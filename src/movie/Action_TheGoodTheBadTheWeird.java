...
public class Action_TheGoodTheBadTheWeird {

	public Action_TheGoodTheBadTheWeird() {
		...
		Label q2 = new Label(i.getAction_TheGoodTheBadTheWeird_Actor());
		...
		Label q3 = new Label(i.getAction_TheGoodTheBadTheWeird_Name());
		...
		ta.append(i.getAction_TheGoodTheBadTheWeird_Outline());
