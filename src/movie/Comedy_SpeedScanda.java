...
public class Comedy_SpeedScanda {

	public Comedy_SpeedScanda() {
		...
		Label q2 = new Label(i.getComedy_SpeedScanda_Actor());
		...
		Label q3 = new Label(i.getComedy_SpeedScanda_Name());
