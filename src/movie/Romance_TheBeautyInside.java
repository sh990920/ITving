...
public class Romance_TheBeautyInside {

	public Romance_TheBeautyInside() {
		...
		Label q2 = new Label(i.getRomance_TheBeautyInside_Actor());
		...
		Label q3 = new Label(i.getRomance_TheBeautyInside_Name());
		...
		ta.append(i.getRomance_TheBeautyInside_Outline());
