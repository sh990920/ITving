...
public class Action_TheAgeOfShadows {

	public Action_TheAgeOfShadows() {
		...
		Label q2 = new Label(i.getAction_TheAgeOfShadows_Actor());
		...
		Label q3 = new Label(i.getAction_TheAgeOfShadows_Name());
		...
		ta.append(i.getAction_TheAgeOfShadows_Outline());
